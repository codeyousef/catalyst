...
use catalyst_proxy::dispatch::Dispatcher;
use catalyst_rpc::{
...
impl CoreHandler for Proxy {
    fn handle_notification(&mut self, rpc: catalyst_rpc::core::CoreNotification) {
    ...
    fn handle_request(
        &mut self,
        _id: catalyst_rpc::RequestId,
        _rpc: catalyst_rpc::core::CoreRequest,
    ) {
    }
}
