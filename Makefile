# This Makefile is intended *only* for building macOS binaries of Catalyst.
...
app: $(APP_NAME)-native ## Create a Catalyst.app
app-universal: $(APP_NAME)-universal ## Create a universal Catalyst.app
$(APP_NAME)-%: $(TARGET)-%
	...
	xattr -c $(APP_DIR)/$(APP_NAME)/Contents/Resources/catalyst.icns
...
dmg: $(DMG_NAME)-native ## Create a Catalyst.dmg
dmg-universal: $(DMG_NAME)-universal ## Create a universal Catalyst.dmg
$(DMG_NAME)-%: $(APP_NAME)-%
